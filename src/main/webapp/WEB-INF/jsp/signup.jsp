...
<html>
    <head>
        ...
        <title>Green Bliss - Sign Up</title>
                          ...
                          <div class="row">
                            <div class="col-md-12 mb-3">
                              <div class="form-outline">
                                  ...
                                  <input name="Cname" type="text" id="cfname" pattern="^[A-Z][a-z]+\s[A-Z][a-z]+$" class="form-control form-control-lg"  required/>                                
                              </div>
                            </div>                           
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-12 mb-3">
                              <div class="form-outline">
                                ...
                                <input name="Cmail" type="email" id="cemail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control form-control-lg" required/>                               
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">                    
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="form-outline">
                                ...
                                <input name="Cmob" type="tel" id="cphone" class="form-control form-control-lg" maxlength="10" minlength="10" required/>
							...
							<div class="col-md-6 mb-3">
							  <div class="form-outline mb-3">
							   <label class="form-label" for="Address">Local Address</label>
								<input name="Cadd" type="text" id="cadd" class="form-control form-control-lg" required/>                            
								<small class="form-text text-muted " style="font-size: 12px;">We currently serve only around Chandrapur city.</small><br>
							  </div>
							</div>
						  </div>     
